...
enum LID_TYPE{AVIA = 1, VELO16, OUST64,RSLIDAR}; //{1, 2, 3,4}
...
//////////////////////////////////////////////////////
// // especially for Apollo SouthBay dataset, also need to replace time with timestamp in preprocess.cpp
// // need exact match for fromROSmsg to read
// namespace velodyne_ros {
//   struct EIGEN_ALIGN16 Point {
//       PCL_ADD_POINT4D;
